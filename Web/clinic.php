        ...
        <div class="container">
            <div class="content_wraper">
                <div class="profile_con">
                    <img src="<?php echo $clinic_logo ?>" class="pull-left" width="100">
                    <h4><?php echo $clinic_name; ?></h4>
                </div>
                   ...
                   <form class="signup_form" action="actions.php?action=signup" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="pull-left hidden-xs hidden-sm">
                            <div class="input-group">
                                <div class="text-center logo_add_btn" style="background: url('<?php echo $clinic_logo; ?>')">
                        ...
                        <div class="">
                            <div class="input-group">
                                ...
                                <input disabled="" type="text" name="name" value="<?php echo $clinic_name; ?>" class="form-control" placeholder="Enter Name of Bussiness/Organization" required />
                            </div>
                            <div class="input-group">
                                <div class="input-group-addon">E-mail</div>
                                <input disabled="" type="email" name="email" value="<?php echo $clinic_email; ?>" class="form-control" placeholder="Email" required />
                            </div>
                            <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input disabled="" type="text" value="<?php echo $clinic_website; ?>" name="website" class="form-control" placeholder="Website Address" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group">
                                <div class="input-group-addon">Phone</div>
                                <input disabled="" type="text" name="phone" value="<?php echo $clinic_phone; ?>" class="form-control" placeholder="Phone number" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input disabled="" type="text" name="location" value="<?php echo $clinic_location; ?>" class="form-control select_location" placeholder="Location" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="input-group">
                                ...
                                <input disabled="" type="text" class="form-control" value="<?php echo $clinic_latitude; ?>" name="latitude" required readonly />
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="input-group">
                                <div class="input-group-addon">Longitude</div>
                                <input disabled="" type="text" class="form-control" value="<?php echo $clinic_longitude; ?>" name="longitude" required readonly />
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="doctor_add_form" method="post" action="actions.php?action=doctor_add" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                ...
                                <input disabled="" type="hidden" name="clinic_id" value="<?php echo $clinic_id; ?>"/>
                            </div>
                            <div class="input-group">
